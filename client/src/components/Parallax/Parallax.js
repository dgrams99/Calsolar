  ...
  return (
    ...
    >
     ...
     <div className='contanier '>
        ...
        <div className='col-8 col-header'>
            ...
            <button className='btn btn-primary quote-btn btn-shift-when-clicked' onClick={() => this.setState({contactPage: true})}>Request Quote</button>                   
        </div>
        </div>
     </div>
    ...
    <div className='info-contanier'>
        ...
        <p className='no-show-on-phone'>When you partner with CalSolar for your solar solutions, you are receiving 
            ...
            <button className='btn btn-primary request-btn-on-content btn-shift-when-clicked' onClick={() => this.setState({contactPage: true})}>Request A Quote</button>
    ...
    <div className='col-12 info-col'>
        ...
        <div className='blue-text top-shift'>
           ...
           <p>Call CalSolar to discuss these options in greater detail at <div className='blue-text big-text'>209-253-0923.</div> OR <br /> <button onClick={() => this.setState({contactPage: true})} className='btn btn-primary contact-btn btn-shift-when-clicked'>Contact Us</button></p>
        </div>
